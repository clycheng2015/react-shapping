    ...
    render() {
        ...
        return (
            <div>
                ...
                {homeData.headlineDto && <News data={homeData.headlineDto}/>}
                        ...
                        switch (i.type) {
                            case 1:
                                switch (i.num) {
                                    ...
                                    case 1:
                                        return <ModelOne key={k} hitory={history}/>
                                            ;
                                    case 2:
                                        return (
                                            <ModelTwo key={k} hitory={history}/>
                                        );
                                    case 3:
                                        return (
                                            <ModelTree key={k} hitory={history}/>
                                        );
                                    case 4:
                                        return (
                                            <ModelFour key={k} hitory={history}/>
                                        )
                                    default:
                                        break;
                                }
