...
class UpdatePhone extends React.Component {
    ...
    _getCode = () => {
        ...
        const {match, sendCode, form, history} = this.props
    ...
    _submite = () => {
        ...
        const {match, sendCode, form, history, fetchUpdate,uid} = this.props
        const {getFieldValue} = form
    ...
    render() {
        ...
        return (
            ...
            <div className="user-update-container" style={{
                width: "100%",
...
export  default createForm()(UpdatePhone)
