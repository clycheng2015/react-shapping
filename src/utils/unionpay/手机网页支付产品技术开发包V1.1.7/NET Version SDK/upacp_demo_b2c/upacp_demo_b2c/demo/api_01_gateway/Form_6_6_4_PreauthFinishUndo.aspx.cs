...
{
    public partial class Form_6_6_4_PreauthFinishUndo : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            param["origQryId"] = Request.Form["origQryId"].ToString();//原预授权完成的queryId，可以从查询接口或者通知接口中获取，此处默认取demo演示页面传递的参数
            ...
            param["txnAmt"] = Request.Form["txnAmt"].ToString(); //交易金额，同原预授权完成的金额
